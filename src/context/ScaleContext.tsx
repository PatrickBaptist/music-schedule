...
const schedules = {
  Janeiro: [],
    ...
    Outubro: [
      ...
      { date: "13/10/2024", teclas: musicians["teclas.1"], batera: musicians["batera.3"], bass: musicians["bass.2"], guita: musicians["guita.2"], vocal1: musicians["vocal.5"], vocal2: musicians["vocal.2"] },
      ...
      { date: "27/10/2024", teclas: musicians["teclas.1"], batera: musicians["batera.1"], bass: musicians["bass.1"], guita: musicians["guita.4"], vocal1: musicians["vocal.3"], vocal2: musicians["vocal.4"] }
    ],
    Novembro: [
