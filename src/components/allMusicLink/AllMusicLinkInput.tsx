...
import { InputContainer, SelectContainer } from './AllMusicLinkInputStyle';
...
const AllMusicLinkInput: React.FC<MusicLinkInputProps> = ({ setIsModalOpen }) => {
...
export default AllMusicLinkInput;